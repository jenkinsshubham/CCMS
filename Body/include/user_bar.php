<div class='panel panel-info' style='margin:12px'>
  ...
  <div class='panel-body' style='padding:12px;'>
    <ul class='nav navbar-nav'>
      ...
      <?php if($_facNotice&&($frm=='f')){?>
      <li>
        <a href='<?php echo BASEPATH ?>page/writeNotice'>
          <span class='glyphicon glyphicon-edit' aria-hidden='true'></span> Add notice</a>
      </li>
      <li>
      ...
      <li><a href='logout'><span class='glyphicon glyphicon-share' aria-hidden='true'></span> Logout</span></a></li>
      </ul>
  </div>
</div>
