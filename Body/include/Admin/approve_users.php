<div class="well col-xs-8 col-sm-8 col-md-8 col-xs-offset-2 col-sm-offset-2 col-md-offset-2">
        <div class="row user-row">
            ...
            <div class="col-xs-8 col-sm-9 col-md-10">
                <strong>Fabio Belli</strong><br>
                <span class="text-muted">Marta Anzolini</span><span class="text-muted">Carlo Rizzi</span>
            </div>
            <div class="col-xs-1 col-sm-1 col-md-1 dropdown-user" data-for=".cyruxx">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-xs-offset-0 col-sm-offset-0 col-md-offset-1">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Marta Anzolini</h3>
                    </div>
