...
<div style="width: 100%" class="panel panel-warning">
	<div class="panel-heading"><h2 class="panel-title">Add Notice</h2></div>
	<div class="panel-body">
		<form method="post">
			<input type="text" required placeholder="Enter title.." name="title" class="form-control">
			<input type="text" required placeholder="Content of the Notice..." name="content" class="form-control">
