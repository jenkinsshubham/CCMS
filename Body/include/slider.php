<script type="text/javascript" src="<?php echo STYLERS ?>js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="<?php echo STYLERS ?>js/jssor.slider.mini.js"></script>
    ...
    <style>
        ...
        */
        ...
        .jssorb13 div, .jssorb13 div:hover, .jssorb13 .av {
            ...
            width: 21px;
            height: 21px;
            background: url('images/img/b13.png') no-repeat;
            overflow: hidden;
            cursor: pointer;
        }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 500px; overflow: hidden;">
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/01.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/02.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/03.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/04.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/05.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/06.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/07.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/08.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/09.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/10.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="<?php echo STYLERS ?>images/img/11.jpg" />
            </div>
